...
namespace not_broforce
{
    public class PlatformController : RaycastController
    {
        ...
        Vector3 CalculatePlatformMovement()
        {
            ...
            float easedPercentBetweemWaypoints = Ease(percentBetweenWaypoint);

            Vector3 newPos = Vector3.Lerp(globalWaypoints[fromWaypointIndex], globalWaypoints[toWaypointIndex], easedPercentBetweemWaypoints);
        ...
        void CalculatePassengerMovement(Vector3 velocity)
        {
            ...
            //Passenger on top of a downward
